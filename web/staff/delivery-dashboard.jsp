...
<%
    ...
    Integer totalDeliveries = (Integer) request.getAttribute("totalDeliveries");
...
<head>
    ...
    <title>Giao Hàng | Sena Shop</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .table th { background: var(--gray-50); padding: 0.75rem 1rem; text-align: left; font-size: 0.8rem; font-weight: 600; color: var(--gray-600); text-transform: uppercase; letter-spacing: 0.05em; border-bottom: 1px solid var(--gray-200); }
        .table td { padding: 0.75rem 1rem; font-size: 0.875rem; border-bottom: 1px solid var(--gray-100); }
        .table tr:last-child td { border-bottom: none; }
        .badge { display: inline-flex; padding: 0.25rem 0.6rem; border-radius: 100px; font-size: 0.75rem; font-weight: 600; }
...
<body>
    <nav class="topnav">
        ...
        <div class="nav-links">
            <a href="${pageContext.request.contextPath}/staff/delivery" class="active">Giao Hàng</a>
    ...
    <div class="layout">
        ...
        <h1 class="page-title"><i class="fas fa-truck"></i> Quản Lý Giao Hàng</h1>
        
        <div class="stats-grid">
            <div class="stat-card">
                <div class="stat-icon blue"><i class="fas fa-box"></i></div>
                <div>
                    <div class="stat-value"><%= totalDeliveries != null ? totalDeliveries : 0 %></div>
                    <div class="stat-label">Tổng Đơn Giao</div>
                </div>
            </div>
            <div class="stat-card">
                <div class="stat-icon orange"><i class="fas fa-clock"></i></div>
                <div>
                    <div class="stat-value"><%= pendingDeliveries != null ? pendingDeliveries : 0 %></div>
            ...
            <div class="stat-card">
                ...
                <div>
                    <div class="stat-value"><%= completedDeliveries != null ? completedDeliveries : 0 %></div>
        ...
        <div class="card">
            <div class="card-header">
                <h2 class="card-title"><i class="fas fa-history"></i> Giao Dịch Gần Đây</h2>
                <a href="${pageContext.request.contextPath}/staff/delivery-history" class="btn btn-primary">
                    Xem Tất Cả <i class="fas fa-arrow-right"></i>
                </a>
            </div>
            
            <% if (recentDeliveries == null || recentDeliveries.isEmpty()) { %>
            <div class="empty-state">
                <i class="fas fa-truck" style="font-size: 2.5rem;"></i>
                <p>Chưa có giao dịch giao hàng nào</p>
            </div>
            <% } else { %>
            <table class="table">
                <thead>
                ...
                <tbody>
                    <% for (DeliveryOrder d : recentDeliveries) { %>
                    <tr>
