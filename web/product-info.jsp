...
<body>
    ...
    <div class="modal-container">
        ...
        <div class="detail-grid">
            <!-- DuyAnhNgo- CỘT TRÁI: Khu vực hiển thị Hình ảnh Sản phẩm (Slider/Carousel) -->
    ...
    <script>
        ...
        var productGalleryImages = [
            <% for (int i = 0; i < productImages.size(); i++) { %>
                "<%= escapeJs(ImageUrlUtil.resolve(productImages.get(i), request.getContextPath())) %>"<%= i < productImages.size() - 1 ? "," : "" %>
            <% } %>
        ];
