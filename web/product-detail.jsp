                                    ...
                                    <%@ page import="service.WishlistService" %>
                                        <%@ page import="service.CartService" %>
                                            <%@ page import="java.util.List" %>
                                                <% // ---- Auth guard ---- Account Account=(Account)
                                                    session.getAttribute("Account"); if (Account==null) {
                                                    response.sendRedirect(request.getContextPath() + "/login" ); return;
                                                    } // ---- Product ---- Product product=(Product)
                                                    request.getAttribute("product"); if (product==null) {
                                                    session.setAttribute("error", "San pham khong ton tai hoac da bi xoa."
                                                    ); response.sendRedirect(request.getContextPath() + "/products" );
                                                    return; } // ---- Current session info ---- String role=(String)
                                                    session.getAttribute("role"); Integer sessionShopIdObj=(Integer)
                                                    session.getAttribute("shopId"); int sessionShopId=(sessionShopIdObj
                                                    !=null) ? sessionShopIdObj : 0; // ---- Is owner of this product's
                                                    shop? ---- boolean isOwner=false; if ("seller".equals(role) &&
                                                    sessionShopId> 0 && sessionShopId == product.getShopId()) {
                                                    isOwner = true;
                                                    }
                                                    ...
                                                    inWishlist = wishlistService.isInWishlist(Account.getId(),
                                                    product.getId());
                                                    ...
                                                    System.err.println("[product-detail.jsp] wishlist error: " +
                                                    e.getMessage());
                                                    inWishlist = false;
                                                    } finally {
                                                    ...
                                                    if (shopInfo == null) {
                                                    shopInfo = new Shop();
                                                    shopInfo.setShopName(product.getShopName() != null ?
                                                    product.getShopName() : "-");
                                                    }
                                                    ...
                                                    String fullname = Account.getFullname() != null ?
                                                    ...
                                                    boolean hasDiscount = salePrice > 0 && salePrice < originalPrice;
                                                        ...
                                                        Math.round(product.getDiscountPercent()); java.text.NumberFormat
                                                        nf=java.text.NumberFormat.getNumberInstance(java.util.Locale.forLanguageTag("vi"));
                                                        // ---- Product Images List ---- List<String> productImages =
                                                        (List<String>) request.getAttribute("productImages");
                                                            if (productImages == null) {
                                                            productImages = new java.util.ArrayList<>();
                                                                }
                                                                if (productImages.isEmpty() && product.getImage() !=
                                                                null && !product.getImage().trim().isEmpty()) {
                                                                ...
                                                                <body>
                                                                    ...
                                                                    <main class="sena-main">
                                                                        ...
                                                                        <div class="breadcrumb">
                                                                            <a href="products"><i
                                                                                    class="fa-solid fa-box"></i> San
                                                                                Pham</a>
                                                                            <i class="fa-solid fa-chevron-right"
                                                                                style="font-size:0.6rem;color:var(--gray-400);"></i>
                                                                            <span>
                                                                                <%= product.getTitle() %>
                                                                            </span>
                                                                        </div>
                                                                                                        ...
                                                                                                        <div class="product-image-wrap"
                                                                                                            ...
                                                                                                            <% if
                                                                                                                ...
                                                                                                                <img id="mainProductImg"
                                                                                                                    src="<%= ImageUrlUtil.resolve(productImages.get(0), request.getContextPath()) %>"
                                                                                                        ...
                                                                                                        <% if
                                                                                                            ...
                                                                                                            <div
                                                                                                                ...
                                                                                                                <% for
                                                                                                                    ...
                                                                                                                    {
                                                                                                                    String
                                                                                                                    imgPath=productImages.get(i);
                                                                                                                    String
                                                                                                                    resolvedUrl=ImageUrlUtil.resolve(imgPath,
                                                                                                                    request.getContextPath());
                                                                                                                    %>
                                                                                                                    <div class="thumb-item <%= i == 0 ? "
                                                                                                                        active"
                                                                                                                        : ""
                                                                                                                        %>
                                                                                                                        "
                                                                                                            ...
                                                                                                            <div
                                                                                                                ...
                                                                                                                <span
                                                                                                                    ...
                                                                                                                    <% if
                                                                                                                        ...
                                                                                                                        %>
                                                                                                                        <%= new
                                                                                                                            java.text.SimpleDateFormat("dd/MM/yyyy").format(product.getExpiredDate())
                                                                                                                            %>
                                                                                                                            <% long
                                                                                                                                now=System.currentTimeMillis();
                                                                                                                                long
                                                                                                                                exp=product.getExpiredDate().getTime();
                                                                                                                                if
                                                                                                                                (exp
                                                                                                                                <
                                                                                                                                now)
                                                                                                                ...
                                                                                                                <span
                                                                                                                    ...
                                                                                                                    <% if
                                                                                                                        ...
                                                                                                                        <span
                                                                                                                            ...
                                                                                                                            <% int
                                                                                                                                full=(int)
                                                                                                                                Math.round(product.getAverageRating());
                                                                                                                                for
                                                                                                                                (int
                                                                                                                                i=0;
                                                                                                                                i
                                                                                                                        ...
                                                                                                                        <span
                                                                                                                            style="font-size:0.82rem;color:var(--gray-600);margin-left:0.25rem;">
                                                                                                                            (
                                                                                                        ...
                                                                                                        <div>
                                                                                                            <div class="section-label"
                                                                                                                ...
                                                                                                                <i class="fa-solid fa-shop"
                                                                                                                    style="font-size:0.75rem;color:var(--green);"></i>
                                                                                                                Cua Hang
                                                                                                                Ban
                                                                                                            </div>
                                                                                                            <div
                                                                                                                ...
                                                                                                                <% if
                                                                                                                    ...
                                                                                                                    !=null
                                                                                                                    &&
                                                                                                                    !shopInfo.getLogo().trim().isEmpty())
                                                                                                                    { %>
                                                                                                                    <img class="shop-avatar"
                                                                                                                        src="<%= ImageUrlUtil.resolve(shopInfo.getLogo(), request.getContextPath()) %>"
                                                                                                        ...
                                                                                                        <div
                                                                                                            ...
                                                                                                            <% if
                                                                                                                ...
                                                                                                                <div
                                                                                                                    ...
                                                                                                                    <div
                                                                                                                        style="display: flex; align-items: center; border: 1.5px solid var(--gray-200); border-radius: var(--radius-sm); overflow: hidden;">
                                                                                                                        <button
                                                                                                                            type="button"
                                        ...
                                        ">
                                                                                                                ...
                                                                                                                <div id="totalPriceContainer"
                                                                                                                    style="margin-bottom: 1rem; padding: 0.75rem 1rem; background: var(--gray-50); border-radius: var(--radius-sm); border: 1px solid var(--gray-200);">
                                                                                                                    <div
                                                                                                                        style="font-size: 0.78rem; color: var(--gray-600); margin-bottom: 0.25rem;">
                                                                                                                        Tong
                                                                                                                        tien:
                                                                                                                    </div>
                                                                                                                        ...
                                                                                                                        <% }
                                                                                                                            ...
                                                                                                                            <% if
                                                                                                                                ...
                                                                                                                                <button
                                                                                                                                    type="button"
                                                                                                                                    id="wishlistBtn"
                                                                                                                                    class="btn btn-wishlist <%= inWishlist ? "
                                                                                                                                    in-wishlist"
                                                                                                                                    : ""
                                                                                                                                    %>"
                                                                                        ...
                                                                                        <div class="card">
                                                                                            ...
                                                                                            <div class="card-body">
                                                                                                <% if
                                                                                                    ...
                                                                                                    { %>
                                                                                                    <div
                                                                                                        style="font-size:0.9rem;line-height:1.75;color:var(--gray-800);white-space:pre-wrap;">
                                                                                                        <%= product.getDescription()
                                                                                                            %>
                                                                                                    </div>
                                                                                                    <% } else { %>
                                                                                                        <p
                                                                                                            style="color:var(--gray-400);font-size:0.875rem;font-style:italic;">
                                                                                                            San pham nay
                                                                                                            chua co mo
                                                                                                            ta chi tiet.
                                                                                                        </p>
                                                                    ...
                                                                    <footer class="footer">
                                                                        <a href="home.jsp" class="footer-logo"><i
                                                                            ...
                                                                            Sena Shop</a>
                                                                        <span class="footer-copy">&copy; 2024 Sena Shop.
                                                                            Trai cay tuoi ngon moi ngay.</span>
                                                                    </footer>
