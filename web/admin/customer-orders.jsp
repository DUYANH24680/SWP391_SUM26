...
<head>
    ...
    <title>L?ch S? Ðon Hàng | <%= customer != null ? customer.getFullname() : "" %> | SenaFruit</title>
...
<body>
    ...
    <div class="layout">
        ...
        <a href="<%= request.getContextPath() %>/admin/customers" class="back-link">
            <i class="fa-solid fa-arrow-left"></i> Quay l?i danh sách khách hàng
        </a>
        ...
        <% if (customer != null) { %>
            ...
            <div class="customer-card">
                ...
                <div class="customer-info-text">
                    <h2><%= customer.getFullname() != null ? customer.getFullname() : "Chua có tên" %></h2>
                    <p>
        ...
        <div class="tabs-card">
            ...
            <button class="tab-btn" onclick="filterOrders('1')">Ch? xác nh?n</button>
            <button class="tab-btn" onclick="filterOrders('2')">Ðã xác nh?n</button>
            <button class="tab-btn" onclick="filterOrders('3')">Ðang giao</button>
            <button class="tab-btn" onclick="filterOrders('4')">Ðã giao</button>
            <button class="tab-btn" onclick="filterOrders('5')">Ðã h?y</button>
        </div>
            ...
            <div class="order-card" data-status="<%= o.getStatus() %>">
                <div class="order-header">
                    <div class="order-date-id">
                        ...
                        <span class="order-id">Mã don: #<%= o.getId() %></span>
                ...
                <div class="order-footer">
                    <div class="order-cost-details">
                        Ti?n hàng: <%= nf.format((long) o.getTotalCost()) %> d
        ...
        %>
            <div class="empty-state">
                ...
                <p>Khách hàng này chua có don hàng nào.</p>
            </div>
        <% } %>
    </div>
