...
<nav class="topnav">
    ...
    <div class="nav-links">
        ...
        <a href="<%= request.getContextPath() %>/admin/customers"><i class="fa-solid fa-users" style="margin-right:4px;"></i>Khách Hàng</a>
        <a href="<%= request.getContextPath() %>/admin/orders"><i class="fa-solid fa-chart-line" style="margin-right:4px;"></i>Monitor Đơn Hàng</a>
        <a href="<%= request.getContextPath() %>/admin/seller-requests"><i class="fa-solid fa-clipboard-list" style="margin-right:4px;"></i>Duyệt Seller</a>
        <a href="<%= request.getContextPath() %>/admin/sellers" class="active"><i class="fa-solid fa-store" style="margin-right:4px;"></i>Quản Lý Sellers</a>
    </div>
    <div class="nav-right">
