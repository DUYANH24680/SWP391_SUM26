...
<head>
    ...
    <title>Quản Lý Shipper | Sena Shop</title>
...
<body>
    <jsp:include page="/admin/admin-topnav.jsp">
        <jsp:param name="activePage" value="shipper" />
    </jsp:include>
    ...
    <div class="layout">
        ...
        <div class="page-header">
            <h1 class="page-title"><i class="fas fa-motorcycle"></i> Quản Lý Shipper</h1>
            <a href="${pageContext.request.contextPath}/admin/shipper/add" class="btn btn-primary">
                <i class="fas fa-plus"></i> Thêm Shipper
            </a>
        </div>
        
        <div class="search-card">
            <form action="${pageContext.request.contextPath}/admin/shipper" method="get" class="search-form">
                ...
                <a href="${pageContext.request.contextPath}/admin/shipper" class="btn btn-sm" style="background: var(--gray-200); color: var(--gray-600);">Xóa lọc</a>
                <% } %>
            </form>
        </div>
        ...
        <div class="table-card">
            ...
            <div class="empty-state">
                ...
                <p>Không có shipper nào<%= keyword != null ? " phù hợp với từ khóa tìm kiếm" : "" %></p>
            </div>
            <% } else { %>
            <table class="table">
                <thead>
