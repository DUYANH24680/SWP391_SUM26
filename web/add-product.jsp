        ...
        <%@ page import="model.Category" %>
            <%@ page import="java.util.List" %>
                <% Object rawUser=session.getAttribute("Account"); Object rawUserId=session.getAttribute("userId");
                    ...
                    System.out.println("[add-product.jsp] rawUserId=" + rawUserId + " type=" + (rawUserId != null ? rawUserId.getClass().getName() : " null")); Account user=(Account)
                    rawUser; if (user==null) { response.sendRedirect(request.getContextPath() + "/login" ); return; }
                    String role=(String) session.getAttribute("role"); String avatarUrl=user.getAvatar(); if
                    (avatarUrl==null || avatarUrl.trim().isEmpty()) { String fullname=user.getFullname() !=null ?
                    user.getFullname() : user.getUsername(); avatarUrl="https://ui-avatars.com/api/?name=" +
                    java.net.URLEncoder.encode(fullname, "UTF-8" )
                    + "&background=4caf50&color=fff&size=80&bold=true&rounded=true" ; } String message=(String)
                    session.getAttribute("message"); String error=(String) session.getAttribute("error");
                    session.removeAttribute("message"); session.removeAttribute("error"); List<Category> categories =
                    (List<Category>) request.getAttribute("categories");
                        ...
                        <body>
                                            ...
                                            <% if (error !=null) { %>
                                                ...
                                                <% } %>
                                                    ...
                                                    <div class="info-box">
                                                        ...
                                                        <span>Sản phẩm sau khi tạo sẽ có trạng thái <strong>Chờ
                                                                duyệt</strong> (status = 0). Bạn chỉ có thể thêm sản
                                                            phẩm khi cửa hàng đã được phê duyệt.</span>
                                                    </div>
                                                    ...
                                                    <form action="add-product" method="POST"
                                                        ...
                                                        <input type="hidden" name="shopId"
                                                            value="<%= session.getAttribute(" shopId") !=null ?
                                                            session.getAttribute("shopId") : 1 %>">
                                                        ...
                                                        <div class="card">
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <div class="form-grid">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label class="form-label">Giá gốc (VNĐ) <span
                                                                                class="required">*</span></label>
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label class="form-label">Số lượng trong kho
                                                                            <span class="required">*</span></label>
                                                                        <input type="number" name="stockQuantity"
                                                                            class="form-control" placeholder="VD: 100"
                                                                            min="0" required>
                                                                    </div>
                                                                    ...
                                                                    <div class="form-group full">
                                                                        <label class="form-label">Mô tả sản phẩm <span
                                                                                class="required">*</span></label>
                            ...
                            <!-- ====== FOOTER ====== -->
                            <footer class="footer">
                                <a href="home.jsp" class="footer-logo"><i class="fa-solid fa-apple-whole"></i> Sena
                                    Shop</a>
