...
<head>
    ...
    <title>Đơn Giao Hàng | SenaFruit</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .filter-row { padding: 1rem 1.5rem; border-bottom: 1px solid var(--gray-200); display: flex; gap: 0.5rem; }
...
<body>
    ...
    <div class="layout">
        ...
        <h1 class="page-title"><i class="fas fa-list"></i> Đơn Giao Hàng Của Tôi</h1>
        
        <div class="card">
            <div class="filter-row">
                <a href="${pageContext.request.contextPath}/shipper/my-deliveries" class="filter-btn <%= !"history".equals(currentFilter) ? "active" : "" %>">
                    <i class="fas fa-clock"></i> Đang Giao
                </a>
                <a href="${pageContext.request.contextPath}/shipper/my-deliveries?filter=history" class="filter-btn <%= "history".equals(currentFilter) ? "active" : "" %>">
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>#<%= d.getOrderId() %></td>
                        <td><%= d.getRecipientName() %><br><small style="color: var(--gray-400);"><%= d.getRecipientPhone() %></small></td>
                        <td><%= d.getDeliveryAddress() != null ? (d.getDeliveryAddress().length() > 30 ? d.getDeliveryAddress().substring(0, 30) + "..." : d.getDeliveryAddress()) : "-" %></td>
