...
<head>
    ...
    <title>Nhập Kho | Sena Shop</title>
...
<div class="layout">
    ...
    <aside class="sidebar">
        <div class="sidebar-nav">
            ...
            <a href="inventory-import" class="active"><i class="fa-solid fa-arrow-down"></i> Nhập Kho</a>
            <a href="inventory-export"><i class="fa-solid fa-arrow-up"></i> Xuất Kho</a>
