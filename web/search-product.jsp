<%@ page contentType="text/html;charset=UTF-8" language="java" %>
    <div class="nav-search search-product-container" style="position: relative; flex: 1; max-width: 440px;">
        ...
        <input type="text" id="searchInput" placeholder="Tìm kiếm trái cây, rau củ..." autocomplete="off"
            style="width: 100%; height: 40px; border: 1.5px solid var(--gray-200); border-radius: 100px; padding: 0 1rem 0 2.8rem; font-size: 0.875rem; font-family: 'Inter', sans-serif; background: var(--gray-50); color: var(--gray-800); outline: none; transition: all 0.2s;">
