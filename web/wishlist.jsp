                    ...
                    <%@ page import="java.text.NumberFormat" %>
                        <%@ page import="java.util.Locale" %>
                            <% Account Account=(Account) session.getAttribute("Account"); if (Account==null) {
                                response.sendRedirect(request.getContextPath() + "/login" ); return; } Wishlist
                                wishlist=(Wishlist) request.getAttribute("wishlist"); if (wishlist==null) { wishlist=new
                                Wishlist(); } String message=(String) session.getAttribute("message"); String
                                error=(String) session.getAttribute("error"); session.removeAttribute("message");
                                session.removeAttribute("error"); NumberFormat
                                nf=NumberFormat.getNumberInstance(Locale.forLanguageTag("vi")); String
                                ...
                                <head>
                                    ...
                                    <title>Yêu Thích | Sena Shop</title>
                                    <link
                                    ...
                                    <style>
                                        ...
                                        *::after {
                                        ...
                                        .wishlist-item {
                                            display: grid;
                                            grid-template-columns: 50px 100px 1.5fr 140px 60px;
                                            gap: 1rem;
                                            align-items: center;
                                        ...
                                        @media (max-width: 900px) {
                                            .wishlist-item {
                                                grid-template-columns: 40px 80px 1fr 120px 60px;
                                            }
                                ...
                                <body>
                                    ...
                                    <nav class="topnav">
                                        ...
                                        <div class="nav-right">
                                            ...
                                            <img class="nav-avatar" src="<%= Account.getAvatar() != null && !Account.getAvatar().trim().isEmpty() ? Account.getAvatar() : "https://ui-avatars.com/api/?name=" + java.net.URLEncoder.encode(Account.getFullname() != null ? Account.getFullname() : "User", "UTF-8") + "&background=4caf50&color=fff&size=80&bold=true&rounded=true" %>" alt="avatar">
                                        </div>
                                    </nav>
                                                        ...
                                                        <div class="wishlist-card">
                                                            <% if (wishlist.isEmpty()) { %>
                                                                <div class="empty-state">
                                                                    ...
                                                                    <p>Hãy thêm sản phẩm yêu thích để lưu lại và chuyển
                                                                        vào giỏ hàng sau.</p>
                                                                    <a href="home.jsp" class="btn btn-green"
                                                                        style="display:inline-flex; margin-top: 0.5rem;">
                                                                        <i class="fa-solid fa-basket-shopping"></i> Khám
                                                                        Phá Sản Phẩm
                                                                    </a>
                                                                </div>
                                                                <% } else { %>
                                                                    ...
                                                                    <div class="select-all-bar">
                                                                        <label class="custom-checkbox"
                                                                            ...
                                                                            <span class="select-info"
                                                                                style="margin-left:0.5rem;">Chọn Tất
                                                                                Cả</span>
                                                                        </label>
                                                                        <span class="select-info"
                                                                            id="selectedCountInfo">
                                                                            Đã chọn <strong
                                                                                id="selectedCountNum">0</strong> / <%=
                                                                                wishlist.getTotalItems() %> sản phẩm
                                                                        </span>
                                                                    </div>

                                                                    <% for (WishlistItem item : wishlist.getItems()) {
                                                                        boolean isOutOfStock=item.getStockQuantity()
                                                                        <=0; boolean isLowStock=item.getStockQuantity()>
                                                                        0 && item.getStockQuantity() <= 20; %>
                                                                            <div class="wishlist-item"
                                                                                    ...
                                                                                    <% if (!isOutOfStock) { %>
                                                                                        ...
                                                                                        <% } else { %>
                                                                                            <span
                                                                                                ...
                                                                                                style="color:var(--gray-400); font-size:0.8rem;">
                                                                                                <i
                                                                                ...
                                                                                <div class="item-image">
                                                                                    <% if (item.getImage() !=null &&
                                                                                        !item.getImage().trim().isEmpty())
                                                                                        { %>
                                                                                        <img src="<%= ImageUrlUtil.resolve(item.getImage(), request.getContextPath()) %>"
                                                                                            alt="<%= item.getTitle() %>"
                                                                                            onerror="this.style.display='none';if(this.nextElementSibling)this.nextElementSibling.style.display='flex';">
                                                                                        <div
                                                                                            style="display:none; width:100%; height:100%; align-items:center; justify-content:center; background:var(--gray-50); border-radius:var(--radius-sm);">
                                                                                            <span
                                                                                                style="font-size: 2rem;">&#127822;</span>
                                                                                        </div>
                                                                                        <% } else { %>
                                                                                            <div
                                                                                                style="width:100%; height:100%; display:flex; align-items:center; justify-content:center; background:var(--gray-50); border-radius:var(--radius-sm);">
                                                                                                <span
                                                                                                    style="font-size: 2rem;">&#127822;</span>
                                                                                            </div>
                                                                                            <% } %>
                                                                                ...
                                                                                <div class="item-details">
                                                                                    <a href="info?id=<%= item.getProductId() %>"
                                                                                        class="item-title">
                                                                                        <%= item.getTitle() !=null ?
                                                                                            item.getTitle() : "Sản phẩm"
                                                                                            %>
                                                                                    </a>
                                                                                    <div class="item-meta">
                                                                                        Đơn giá: <strong>
                                                                                    ...
                                                                                    <div class="item-meta">
                                                                                        <% if (isOutOfStock) { %>
                                                                                            ...
                                                                                            <% } else if (isLowStock) {
                                                                                                ...
                                                                                                <% } else { %>
                                                                                                    <span
                                                                                                        class="stock-badge stock-available">
                                                                                                        <i
                                                                                    ...
                                                                                    <% if (item.getAverageRating()> 0) {
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <span class="rating-stars">
                                                                                                <% int fullStars=(int)
                                                                                                    Math.floor(item.getAverageRating());
                                                                                                    %>
                                                                                                    <% for (int s=0; s <
                                                                                                        fullStars; s++)
                                                                                                        { %>
                                                                            ...
                                                                            <% } %>
                                                                                ...
                                                                                <div class="bottom-bar">
                                                                                    <div class="left-info">
                                                                                        Đã chọn <strong
                                                                                            id="summarySelectedCount">0</strong>
                                                                                        sản phẩm
                                                                                    </div>
                                                                                    <div class="right-actions">
                                                                                        ...
                                                                                        <form id="moveToCartForm"
                                                                                            action="move-wishlist-to-cart-redirect"
                                                                                            method="POST"
                                                                                            style="display:inline;">
                                                                                            <input type="hidden"
