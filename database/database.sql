-- ============================================================
-- FRUIT SHOP SYSTEM - DATABASE HOÀN CHỈNH (FIXED & CLEANED)
-- Phiên bản: 2.1 (Đã loại bỏ hoàn toàn seller_id dư thừa)
-- ============================================================
...
-- ============================================================
-- 3. PRODUCTS: Sản phẩm trái cây (Đã chuẩn hóa, bỏ seller_id)
...
-- ============================================================
-- INDEXES (ĐÃ SỬA: Thay thế IX_Products_Seller bằng IX_Products_Shop)
-- ============================================================
CREATE INDEX IX_Accounts_Role     ON Accounts(role_id);
CREATE INDEX IX_Products_Category ON Products(category_id);
CREATE INDEX IX_Products_Shop     ON Products(shop_id); -- Sửa đổi tại đây
...
VALUES
(1, N'Quản Trị Viên',    'admin',     '1', 'admin@fruitshop.com',    '0900000001', 1),
(2, N'Nhân Viên Bán',    'seller',    '1', 'seller@fruitshop.com',   '0900000002', 1),
(3, N'Nguyễn Văn Khách', 'customer1', '1', 'customer1@gmail.com',    '0912345678', 1),
(3, N'Trần Thị Mua',     'customer2', '1', 'customer2@gmail.com',    '0987654321', 1),
(4, N'Lê Văn Shipper',   'shipper1',  '1', 'shipper1@fruitshop.com', '0933000001', 1);

-- Shops
INSERT INTO Shops (owner_id, shop_name, logo, description, address, status)
VALUES 
(2, N'Sena Fruit Store', 'logo_sena.png', N'Chuyên trái cây sạch nhập khẩu và nội địa', N'123 Đường Ba Đình, Hà Nội', 1);
...
-- Products
INSERT INTO Products(category_id, shop_id, title, image, description, unit, stock_quantity, original_price, sale_price, status)
VALUES
(1, 1, N'Táo Mỹ Fuji',         'apple.png',  N'Táo Fuji nhập khẩu từ Mỹ, giòn ngọt',         N'kg', 100, 120000,  99000, 1),
(1, 1, N'Nho Úc không hạt',    'grape.png',  N'Nho Úc tươi ngon, không hạt',                  N'kg',  80, 180000, 150000, 1),
(2, 1, N'Xoài cát Hòa Lộc',   'mango.png',  N'Xoài cát Hòa Lộc đặc sản miền Nam',            N'kg', 150,  65000,   NULL, 1),
(3, 1, N'Cam hữu cơ Đà Lạt',  'orange.png', N'Cam hữu cơ trồng tại Đà Lạt',                  N'kg', 120,  55000,  45000, 1),
(4, 1, N'Sầu riêng Musang King','durian.png',N'Sầu riêng Musang King nhập khẩu Malaysia',      N'kg',  40, 350000, 320000, 1);
