...
public class EmailService {
    ...
    public static boolean sendPasswordResetEmail(String recipientEmail, String resetLink, String userName) {
        try {
            ...
            // BẬT DEBUG để in toàn bộ phiên SMTP ra console Tomcat - giúp xác định lỗi thật
            ...
            // Lỗi xác thực: sai App Password, hoặc Workspace domain chặn App Password / SMTP
            System.err.println("AUTH FAILED - kiểm tra lại: (1) 2-Step Verification đã bật chưa, "
                    + "(2) App Password còn hiệu lực không, (3) domain @fpt.edu.vn có bị admin chặn SMTP không. "
